...
public class Lot {
    ...
    // Phase 8 handover confirmation lives directly on the lot (known
    // simplification: the full handover_records audit table is intentionally
    // not used — see V7 migration comment).
    @Column(name = "handed_over_at") private LocalDateTime handedOverAt;
    @Column(name = "recycler_confirmed_at") private LocalDateTime recyclerConfirmedAt;
